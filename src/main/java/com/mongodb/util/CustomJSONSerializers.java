...
public class CustomJSONSerializers {
    ...
    private CustomJSONSerializers() {
    }
    
    public static ObjectSerializer getJS() {

        ClassMapBasedObjectSerializer serializer = addCommonSerializers();

        serializer.addObjectSerializer(Date.class, new JSDateSerializer(serializer));
    ...
    private static class JSDateSerializer extends CompoundObjectSerializer {

        JSDateSerializer(ObjectSerializer serializer) {
            super(serializer);
        }
        ...
        public void serialize(Object obj,  StringBuilder buf) {
            ...
            buf.append("new Date(").append(d.getTime()).append(")");
        }
